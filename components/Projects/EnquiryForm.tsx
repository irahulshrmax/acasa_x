...
export default function EnquiryForm({
  ...
  return (
    <div className={`border bg-white ${className}`} style={{ borderColor: THEME.border }}>
      ...
      >
        {agentPhoto ? (
          <img src={agentPhoto} alt={agentName} className="h-10 w-10 rounded-full object-cover border" />
        ) : (
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[9px] uppercase tracking-[0.1em]" style={{ color: THEME.muted }}>
            Your Agent <span className="text-[#C9A96E]">●</span> Click for details
          </p>
        </div>
          ...
          {done ? (
            ...
            <motion.form key="form" initial={{ opacity: 1 }} exit={{ opacity: 0 }} onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                <a
                  href={`https://wa.me/${agentPhone.replace(/\s/g, "")}`}
                  target="_blank"
                  rel="noreferrer"
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-4">
                {agentPhoto ? (
                  <img src={agentPhoto} alt={agentName} className="h-16 w-16 rounded-full object-cover border-2" />
                ) : (
              ...
              <div className="border-t pt-4" style={{ borderColor: THEME.border }}>
                <p className="text-[11px]" style={{ color: THEME.muted }}>
                  This agent will receive your enquiry for <strong className="text-[#0F1C2E]">{projectName}</strong>
                </p>
