...
function SimilarCard({ property, index }: { property: any; index: number }) {
  ...
  return (
    <motion.div
      ...
      onClick={() => router.push(`/properties-for-sale/${property.slug}`)}
    ...
    (async () => {
      try {
        const res = await fetch(
          `${API_URL}?page=1&limit=6&sort_by=newest&listing_type=Resale&status=5`
        );
...
export default function PropertyForSaleDetailPage() {
  ...
  const isResale = property.listing_type === "Resale";
        ...
        <div className="mx-auto max-w-[1180px] px-4 py-3 md:px-6">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-1.5 text-[10px] uppercase tracking-[0.1em]" style={{ color: THEME.muted }}>
              ...
              <Link href="/properties-for-sale" className="hover:text-gray-600 transition-colors">
                Properties for Sale
              </Link>
              <ChevronLeft className="h-3 w-3 rotate-180" />
      ...
      <div className="mx-auto max-w-[1180px] px-4 pt-8 pb-6 md:px-6">
        <div className="flex flex-wrap items-start justify-between gap-6">
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap gap-2 mb-3">
              ...
              {property.listing_type && (
                <span
                  className={`px-2.5 py-1 text-[8px] font-medium uppercase tracking-[0.15em] border ${
                    isResale ? "bg-blue-50 text-blue-700 border-blue-200" : ""
                  }`}
              ...
              {property.completion_date && (
                <span className="flex items-center gap-1 px-2.5 py-1 text-[8px] font-medium uppercase tracking-[0.15em] bg-green-50 text-green-700 border border-green-200">
          ...
          <div className="shrink-0 text-right">
            ...
            {property.price?.rental_price && isResale && (
                ...
                >
                  ...
                  {property.description ? (
                    ...
                    <p className="text-[13px] leading-relaxed" style={{ color: "#4A5462" }}>
                      Welcome to {property.property_name}, a distinguished residential property
                      in {location}, Dubai. This premium property offers an exceptional living
                      experience with world-class amenities.
                    </p>
                  )}
