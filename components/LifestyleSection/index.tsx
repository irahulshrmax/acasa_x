...
const LIFESTYLE_DATA: Lifestyle[] = [
  {
    ...
    type: "Villa",
    isFeatured: true,
    description: "Luxurious beachfront villa with panoramic sea views, private pool, and direct beach access.",
    amenities: ["Private Pool", "Beach Access", "Home Theater", "Gym", "Spa", "Smart Home"],
    yearBuilt: "2023",
  },
  {
    id: 2,
    ...
    type: "Apartment",
    isNew: true,
    description: "Stunning high-rise apartment with breathtaking views of Burj Khalifa and Dubai Fountain.",
    amenities: ["Concierge", "Infinity Pool", "Gym", "Children's Play Area", "Parking"],
    yearBuilt: "2024",
  },
  {
    id: 3,
    ...
    type: "Penthouse",
    isFeatured: true,
    description: "Exclusive penthouse with wraparound terrace, private jacuzzi, and stunning canal views.",
    amenities: ["Private Terrace", "Jacuzzi", "Smart Home", "Valet Parking", "Security"],
    yearBuilt: "2023",
  },
  {
    id: 4,
    ...
    area: "12,000 sqft",
    type: "Villa",
    description: "Palatial estate in the prestigious Emirates Hills community with landscaped gardens.",
    amenities: ["Landscaped Gardens", "Private Pool", "Tennis Court", "Staff Quarters", "Security"],
    yearBuilt: "2022",
  },
  {
    id: 5,
    ...
    type: "Apartment",
    isNew: true,
    description: "Modern apartment with stunning marina and city views in the heart of Dubai Marina.",
    amenities: ["Marina Views", "Pool", "Gym", "Concierge", "Parking"],
    yearBuilt: "2024",
  },
  {
    id: 6,
    ...
    area: "9,800 sqft",
    type: "Townhouse",
    description: "Tranquil townhouse surrounded by lush greenery and serene water features.",
    amenities: ["Green Surroundings", "Private Garden", "Pool", "Gym", "Security"],
    yearBuilt: "2023",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="relative overflow-hidden rounded-[12px] bg-gray-100 shadow-sm transition-shadow duration-300 group-hover:shadow-xl">
        ...
        <div
          ...
          style={{ backfaceVisibility: "hidden" }}
        >
          <div className="h-full w-full rounded-[12px] bg-[#192334] p-6 shadow-xl flex flex-col justify-between">
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">{item.title}</h3>
              <p className="text-sm text-[#C8AA78] font-medium">{item.price}</p>
              <p className="text-xs text-gray-300 mt-2 leading-relaxed">
                {item.description || "Experience luxury living at its finest in this exceptional property."}
              </p>
              
              <div className="mt-4">
                <p className="text-[10px] uppercase tracking-[0.1em] text-[#C8AA78] font-semibold mb-2">
                  Key Features
                </p>
                <div className="flex flex-wrap gap-1.5">
                  {item.amenities?.slice(0, 4).map((amenity, idx) => (
                    <span
                      key={idx}
                      className="text-[9px] bg-white/10 text-gray-300 px-2.5 py-1 rounded-full"
                    >
                      {amenity}
                    </span>
                  ))}
                  {item.amenities && item.amenities.length > 4 && (
                    <span className="text-[9px] bg-white/10 text-gray-300 px-2.5 py-1 rounded-full">
