          ...
          {done ? (
            ...
            >
              ...
              <div>
                ...
                <textarea
                  rows={3}
                  placeholder="I'm interested in this off plan property..."
                  value={form.message}
...
function SimilarCard({ property, index }: { property: any; index: number }) {
  ...
  return (
    <motion.div
      ...
      onClick={() => router.push(`/offplan-properties/${property.slug}`)}
        ...
        <div className="mb-10 flex items-end justify-between">
          <div>
            ...
            <h2 className="text-[28px]" style={{ fontFamily: FONT_DISPLAY, color: THEME.primary }}>
              Similar Off Plan Properties
            </h2>
          </div>
          <Link
            href="/offplan-properties"
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const data = await res.json();
        if (!res.ok || !data.success) throw new Error(data.message || "Off plan property not found");
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-white">
        <div className="text-center px-4">
          ...
          <p className="text-sm text-red-500 mb-6">{error || "Off plan property not found"}</p>
          <Link
            href="/offplan-properties"
        ...
        <div className="mx-auto max-w-[1180px] px-4 py-3 md:px-6">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-1.5 text-[10px] uppercase tracking-[0.1em]" style={{ color: THEME.muted }}>
              ...
              <Link href="/offplan-properties" className="hover:text-gray-600 transition-colors">
                Off Plan Properties
              </Link>
              <ChevronLeft className="h-3 w-3 rotate-180" />
                ...
                >
                  ...
                  {property.description ? (
                    ...
                    <p className="text-[13px] leading-relaxed" style={{ color: "#4A5462" }}>
                      Welcome to {property.property_name}, a premium off plan development
